...
async def get_call_execution_config_by_merchant_id(merchant_id: str) -> List[CallExecutionConfig]:
    """
    ...
    try:
        ...
        if result:
            ...
            logger.info(f"Found {len(decoded_result)} call execution configs for merchant ID: {merchant_id}")
            return decoded_result
