...
class HighlightTagParser:
    ...
    def parse_highlight_tags(self, text: str, chart_context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        ...
        for match in reversed(matches):
            ...
            clean_text = clean_text[:match.start()] + spoken_text + clean_text[match.end():]
