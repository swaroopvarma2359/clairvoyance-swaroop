...
class ToolCall(BaseModel):
    ...
    @classmethod
    def create(cls, id: str, function_name: str, arguments: Dict[str, Any], 
               timestamp: Optional[float] = None, status: str = "in_progress") -> "ToolCall":
...
class ConversationTurn(BaseModel):
    ...
    def add_tool_call(self, function_name: str, arguments: Dict[str, Any], tool_call_id: str, status: str = "in_progress") -> ToolCall:
    ...
    def add_tool_result(self, tool_call_id: str, function_name: str, result: str, success: bool) -> ToolResult:
